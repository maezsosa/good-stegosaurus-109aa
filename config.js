module.exports = {
  ...
  authorName: 'Matias Ezequiel Sosa',
  heading: 'Frontend & Mobile Team Lead',
  // social
  socialLinks: [
    {
      icon: 'fa-github',
      name: 'Github',
      url: 'https://github.com/maezsosa',
    },
    {
      icon: 'fa-twitter',
      name: 'Twitter',
      url: 'https://twitter.com/maezsosa',
    },
    {
      icon: 'fa-linkedin',
      name: 'linkedin',
    ...
    },
    {
      icon: 'fa-envelope-o',
      name: 'Email',
      url: 'mailto:matiasesosa@gmail.com',
    },
  ],
};
